...
// CONSTRUCTORS
    ...
    public HourlyEmployee(int id, Name name, Date hireDate, Date birthDate, float totalHours, float rateHour){
        super(id, name, hireDate, birthDate);
        this.totalHoursWorked  = totalHours;
        this.ratePerHour = rateHour;
    }
    
    public HourlyEmployee(int id, Name name, int yearHire, int monthHire, int dayHire, int yearBirth, int monthBirth, int dayBirth, float totalHours, float rateHour){
        super(id, name, yearHire, monthHire, dayHire, yearBirth, monthBirth, dayBirth);
        this.totalHoursWorked = totalHours;
        this.ratePerHour = rateHour;
    }
    
    public HourlyEmployee(int id, Name name, String hireDate, String birthDate, float totalHours, float rateHour){
        super(id, name, hireDate, birthDate);
        this.totalHoursWorked = totalHours;
        this.ratePerHour = rateHour;
     }
