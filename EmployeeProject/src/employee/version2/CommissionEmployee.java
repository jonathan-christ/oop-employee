...
//  CONSTRUCTORS
    ...
    public CommissionEmployee(int id, String name, Date hireDate, Date birthDate, double sales){
    ...
    public CommissionEmployee(int id, String name, String hireDate, String birthDate, double sales){
        super(id, name, hireDate, birthDate);
        this.totalSales = sales;
     }
